    ...
    <div class="table-responsive">
      <table class="table table-bordered order-table" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody id="tbody-material">
          ...
          ?>
            <tr class="trow" style="text-align: center;" id="fila-<?php echo $obj->id_socio ?>">
              <!--REFERENCIA PADRE-->
              <td><?php echo $obj->cedula; ?></td>
              <td><?php echo "$obj->nombre $obj->apellido" ?></td>
                <td>
                  <!-- Button trigger modal -->
                  <a class="btn <?php if($obj->estado=='listo') { echo 'btn-outline-success'; }else{ echo 'btn-outline-danger';} ?>" href="<?php echo constant('URL') ?>consultartarea/tarea/<?php echo $obj->id_socio ?>">
