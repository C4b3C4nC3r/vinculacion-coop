...
<div  class="card shadow mb-1">
  <div class="card-header py-3">
    ...
    <a data-bs-toggle="tooltip" class="btn btn-outline-primary data-bs-placement-top" title="Revisar Los Registros" href="<?php echo constant('URL') ?>consultartarea/socio/<?php echo $_SESSION["id_pedido"]?>">
        ...
        <tbody id="tbody-material">
          ...
          ?>
            <tr class="trow" style="text-align: center;" id="fila-<?php echo $obj->id_tarea ?>">
              ...
              <td><?php echo $obj->fecha_entregado?></td>
                <td>
                  <!-- Button trigger modal -->
                  <a class="btn <?php if($obj->fecha_entregado!='pendiente') { echo 'btn-outline-success'; }else{ echo 'btn-outline-danger';} ?>" href="<?php echo constant('URL') ?>consultartarea/verTarea/<?php echo $obj->id_tarea ?>">
