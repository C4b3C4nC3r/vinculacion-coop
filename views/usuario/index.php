...
<!--diseño de encabezado!-->
      <h6 class="m-2 font-weight-bold text-primary">Registro de Nuevos Usuarios o
    ...
    <form  id="formulario_usuario">
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <input name="nombre_usuario" type="text" class="form-control" id="nombre_usuario" required>
        </div>
