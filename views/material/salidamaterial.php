...
<div style="padding: 0px 10px 20px 20px; " class="card shadow mb-1">
  <div class="card-header py-5">
    ...
    <h6 class="m-2 font-weight-bold text-primary">
      Registro de la Salida de Material
      <a data-bs-toggle="tooltip" class="btn btn-outline-primary data-bs-placement-top" title="Revisar Los Registros" href="<?php echo constant('URL') ?>consultarsalidamaterial">
...
<div id="response">
  ...
  <div class="col-12">
  <?php
    require 'detalle_material.php';
   ?>
 </div>
 <div class="form-group col-3">
   <button disabled id="save" type="submit" class="btn btn-primary">Guardar</button>
 </div>
 <div class="form-group col-1">
   <button type="reset" id="botonCancelarSalida" class="botonCancelarSalida btn btn-secondary disabled">Cancelar</button>
 </div>
</div>
