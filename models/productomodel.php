  ...
  public function insertarProducto($datos){
    ...
    */
    ...
    try {
      ...
      ===========================================================================================
      */
      $consulta=$this->db->connect()->prepare("INSERT INTO producto (id_categoria_producto,codigo_producto,producto,descripcion,foto,precio)VALUES (:id_categoria_producto,:codigo_producto,:producto,:descripcion,:foto,:precio)");
      //executamos e indicamosque va con quien
      $consulta->execute(['id_categoria_producto'=>$datos['id_categoria_producto'],'codigo_producto'=>$datos['codigo_producto'],'producto'=>$datos['producto'],'descripcion'=>$datos['descripcion'],'foto'=>$datos['foto'] ,'precio'=>$datos['precio']]);
